...
while True:
    ...
    if (rects is not None) and (t_img is not None):
        for (x, y, w, h) in rects:
            ...
            # Define the region of interest (ROI) for the forehead (upper 1/3rd of the face)
            forehead_roi_y = y1
            forehead_roi_h = y2 // 3  # 1/3rd of the face height
            forehead_roi_x = x1
            forehead_roi_w = x2
            tmax = t_img[y1:forehead_roi_h, x1:x2].max()
